...
public abstract class Hilt_AddCharacterFragment<VB extends ViewBinding, VM extends ViewModel> extends BaseFragment<VB, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddCharacterFragment_GeneratedInjector) this.generatedComponent()).injectAddCharacterFragment(UnsafeCasts.<AddCharacterFragment>unsafeCast(this));
    }
  }
