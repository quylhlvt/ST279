...
public abstract class Hilt_CustomizeFragment<VB extends ViewBinding, VM extends ViewModel> extends BaseFragment<VB, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CustomizeFragment_GeneratedInjector) this.generatedComponent()).injectCustomizeFragment(UnsafeCasts.<CustomizeFragment>unsafeCast(this));
    }
  }
