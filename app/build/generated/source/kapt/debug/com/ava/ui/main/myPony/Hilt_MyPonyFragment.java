...
public abstract class Hilt_MyPonyFragment<VB extends ViewBinding, VM extends ViewModel> extends WhatsappSharingFragment<VB, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyPonyFragment_GeneratedInjector) this.generatedComponent()).injectMyPonyFragment(UnsafeCasts.<MyPonyFragment>unsafeCast(this));
    }
  }
