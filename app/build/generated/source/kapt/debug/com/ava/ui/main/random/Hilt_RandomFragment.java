...
public abstract class Hilt_RandomFragment<VB extends ViewBinding, VM extends ViewModel> extends BaseFragment<VB, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RandomFragment_GeneratedInjector) this.generatedComponent()).injectRandomFragment(UnsafeCasts.<RandomFragment>unsafeCast(this));
    }
  }
