...
public abstract class Hilt_CosplayFragment<VB extends ViewBinding, VM extends ViewModel> extends BaseFragment<VB, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CosplayFragment_GeneratedInjector) this.generatedComponent()).injectCosplayFragment(UnsafeCasts.<CosplayFragment>unsafeCast(this));
    }
  }
