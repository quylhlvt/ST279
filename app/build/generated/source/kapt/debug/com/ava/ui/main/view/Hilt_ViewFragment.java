...
public abstract class Hilt_ViewFragment<VB extends ViewBinding, VM extends ViewModel> extends BaseFragment<VB, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ViewFragment_GeneratedInjector) this.generatedComponent()).injectViewFragment(UnsafeCasts.<ViewFragment>unsafeCast(this));
    }
  }
