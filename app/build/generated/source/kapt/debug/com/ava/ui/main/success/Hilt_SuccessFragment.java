...
public abstract class Hilt_SuccessFragment<VB extends ViewBinding, VM extends ViewModel> extends BaseFragment<VB, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SuccessFragment_GeneratedInjector) this.generatedComponent()).injectSuccessFragment(UnsafeCasts.<SuccessFragment>unsafeCast(this));
    }
  }
