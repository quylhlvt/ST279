...
public abstract class Hilt_ShowFragment<VB extends ViewBinding, VM extends ViewModel> extends BaseFragment<VB, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ShowFragment_GeneratedInjector) this.generatedComponent()).injectShowFragment(UnsafeCasts.<ShowFragment>unsafeCast(this));
    }
  }
