...
public abstract class Hilt_ChoosePonyFragment<VB extends ViewBinding, VM extends ViewModel> extends BaseFragment<VB, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChoosePonyFragment_GeneratedInjector) this.generatedComponent()).injectChoosePonyFragment(UnsafeCasts.<ChoosePonyFragment>unsafeCast(this));
    }
  }
