...
public abstract class Hilt_SuccessCosplayFragment<VB extends ViewBinding, VM extends ViewModel> extends BaseFragment<VB, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SuccessCosplayFragment_GeneratedInjector) this.generatedComponent()).injectSuccessCosplayFragment(UnsafeCasts.<SuccessCosplayFragment>unsafeCast(this));
    }
  }
