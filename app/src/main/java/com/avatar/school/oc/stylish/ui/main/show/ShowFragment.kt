package com.avatar.school.oc.stylish.ui.main.show
...
import com.avatar.school.oc.stylish.ui.main.customize.ColorAdapter
import com.avatar.school.oc.stylish.ui.main.customize.NavAdapter
import com.avatar.school.oc.stylish.ui.main.customize.PartAdapter
...
import com.avatar.school.oc.stylish.databinding.FragmentShowBinding
...
//        }
    ...
    override fun onResume() {
        ...
        if (viewModelActivity.shouldRestartShow) {
            ...
            // Restart
            binding.actionBar.tvCenter.text = "10:00"
            startCountDown()
            readArgsAndInit()
            return
        }
