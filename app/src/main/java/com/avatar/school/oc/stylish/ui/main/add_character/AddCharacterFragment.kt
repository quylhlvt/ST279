package com.avatar.school.oc.stylish.ui.main.add_character
...
import com.avatar.school.oc.stylish.core.base.BackPressHandler
import com.avatar.school.oc.stylish.core.base.BaseFragment
import com.avatar.school.oc.stylish.core.custom.Draw
import com.avatar.school.oc.stylish.core.custom.DrawableDraw
import com.avatar.school.oc.stylish.core.custom.listener.listenerdraw.OnDrawListener
import com.avatar.school.oc.stylish.core.dialog.ChooseColorDialog
import com.avatar.school.oc.stylish.core.dialog.DialogSpeech
import com.avatar.school.oc.stylish.core.extention.dp
import com.avatar.school.oc.stylish.core.extention.drawToBitmap
import com.avatar.school.oc.stylish.core.extention.gone
import com.avatar.school.oc.stylish.core.extention.hideNavigation
import com.avatar.school.oc.stylish.core.extention.hideSoftKeyboard
import com.avatar.school.oc.stylish.core.extention.loadImage
import com.avatar.school.oc.stylish.core.extention.onClick
import com.avatar.school.oc.stylish.core.extention.setFont
...
import com.avatar.school.oc.stylish.core.helper.BitmapHelper
import com.avatar.school.oc.stylish.ui.main.add_character.adapter.BackgroundColorAdapter
import com.avatar.school.oc.stylish.ui.main.add_character.adapter.BackgroundCategoryAdapter
import com.avatar.school.oc.stylish.ui.main.add_character.adapter.StickerCategoryAdapter
import androidx.recyclerview.widget.LinearLayoutManager
import com.avatar.school.oc.stylish.core.custom.DrawView
import com.avatar.school.oc.stylish.core.extention.InternetExtension
import com.avatar.school.oc.stylish.data.datalocal.manager.CharacterImageManager
import com.avatar.school.oc.stylish.databinding.FragmentAddCharacterBinding
import com.avatar.school.oc.stylish.ui.main.add_character.adapter.BackgroundImageAdapter
import com.avatar.school.oc.stylish.ui.main.add_character.adapter.SpeechAdapter
import com.avatar.school.oc.stylish.ui.main.add_character.adapter.StickerAdapter
import com.avatar.school.oc.stylish.ui.main.add_character.adapter.TextColorAdapter
import com.avatar.school.oc.stylish.ui.main.add_character.adapter.TextFontAdapter
import com.avatar.school.oc.stylish.ui.onboarding.permission.PermissionViewModel
import com.avatar.school.oc.stylish.utils.DataLocal
import com.avatar.school.oc.stylish.utils.key.ValueKey
...
//            }
    ...
    private fun checkNetworkBeforeRemoteAsset(path: String): Boolean {
        ...
        if (!InternetExtension.isInternetAvailable(requireContext()) || !InternetExtension.isNetworkConnected(
                requireContext()
            )
        ) {
